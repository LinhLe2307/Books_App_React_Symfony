 ...
 */
final class Version20220602183612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payment_card (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(100) DEFAULT NULL, card_number VARCHAR(255) NOT NULL, cvv VARCHAR(255) NOT NULL, valid_month INT NOT NULL, valid_year INT NOT NULL, save_card TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
