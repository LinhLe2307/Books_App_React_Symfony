 ...
 */
final class Version20220524093355 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE payment_card (id INT AUTO_INCREMENT NOT NULL, card_id INT NOT NULL, user_id INT NOT NULL, card_number VARCHAR(255) NOT NULL, cvv VARCHAR(255) NOT NULL, valid_month VARCHAR(255) NOT NULL, valid_year VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
